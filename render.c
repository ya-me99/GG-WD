...
Points Points_Build(uint32_t units,uint32_t load)
{
 ...
 pts.data=ArrayF32_Build(500,100);
 pts.count=0;
 pts.need_update=0;
 pts.units=units;
 pts.load=load;
...
{
 ArrayF32_Add(point.x,&(points->data));
 ArrayF32_Add(point.y,&(points->data));
 ArrayF32_Add(point.r,&(points->data));
 ArrayF32_Add(point.g,&(points->data));
 ArrayF32_Add(point.b,&(points->data));
 ArrayF32_Add(point.a,&(points->data));
 ArrayF32_Add(point.size,&(points->data));
